...
namespace ArquiteturaDesafio.Tests.Application.Handlers
{
    public class CreateUserHandlerTests
    {
        ...
        public async Task Handle_Should_CreateUser_When_RequestIsValid()
        {
            ...
            _mapper.Map<Entities.User>(request).Returns(_user);
            _userRepository.GetByLoginAsync(request.Username).Returns(Task.FromResult<Entities.User>(null));
            _userRepository.GetByEmailAsync(request.Email).Returns(Task.FromResult<Entities.User>(null));
            ...
            _userRepository.Received().Create(Arg.Any<Entities.User>());
        }
