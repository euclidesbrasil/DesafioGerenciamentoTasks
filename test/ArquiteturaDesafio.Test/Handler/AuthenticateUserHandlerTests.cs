...
namespace ArquiteturaDesafio.Tests.Application.Handlers
{
    public class AuthenticateUserHandlerTests
    {
        ...
        public async Task Handle_ShouldReturnSuccessWhenCredentialsAreValid()
        {
            ...
            var user = new Entities.User(_faker.Internet.Email(), request.Username, request.Password, _faker.Name.FullName(), _faker.Address.Country(),
            ...
            _tokenService.GenerateJwtToken(user.Username, user.Role.ToString(), user.Id).Returns("validToken");
        ...
        public async Task Handle_ShouldReturnFailureWhenUserIsNotFound()
        {
            ...
            _repository.GetByLoginAsync(request.Username).Returns((Entities.User)null);
